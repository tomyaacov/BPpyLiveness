...
#SBATCH --mem=50G ### total amount of RAM // 500
#SBATCH --ntasks=1
...
/usr/bin/time -a -o $out_file_name -f "time:%E,memory:%M" ~/.conda/envs/BPpyLiveness/bin/python main_dfs_single.py --n $n --k $k --m $m > $out_file_name