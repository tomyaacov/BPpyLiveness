...
#SBATCH --job-name run_main_multi_c ### name of the job. replace my_job with your desired job name
#SBATCH --output run_main_multi_c.out ### output log for running job - %J is the job number variable
