...
#SBATCH --job-name run_main_50 ### name of the job. replace my_job with your desired job name
#SBATCH --output run_main_50.out ### output log for running job - %J is the job number variable
